...
-- Actual columns: id, nombre, apiEndpoint, tipoServicio, apiKey
IF NOT EXISTS (SELECT 1 FROM Proveedor WHERE id = 1)
BEGIN
        SET IDENTITY_INSERT Proveedor ON;
INSERT INTO Proveedor (id, nombre, apiEndpoint, tipoServicio, apiKey) VALUES (1, 'Distribuidora La Central', 'https://api.central.com/v1', 1, 'api_key_central_123');
INSERT INTO Proveedor (id, nombre, apiEndpoint, tipoServicio, apiKey) VALUES (2, 'Mayorista Del Norte', 'http://soap.norte.com/services', 2, 'api_key_norte_456');
INSERT INTO Proveedor (id, nombre, apiEndpoint, tipoServicio, apiKey) VALUES (3, 'Alimentos Frescos SA', 'https://api.frescos.com/rest', 1, 'api_key_frescos_789');
...
-- ProductoProveedor columns: idProveedor, codigoBarra, codigoBarraProveedor, fechaActualizacion, estado
IF NOT EXISTS (SELECT 1 FROM ProductoProveedor WHERE codigoBarra = 1001 AND idProveedor = 1)
    INSERT INTO ProductoProveedor (codigoBarra, idProveedor, codigoBarraProveedor, estado) VALUES (1001, 1, 2001, 1);

IF NOT EXISTS (SELECT 1 FROM ProductoProveedor WHERE codigoBarra = 1002 AND idProveedor = 1)
    INSERT INTO ProductoProveedor (codigoBarra, idProveedor, codigoBarraProveedor, estado) VALUES (1002, 1, 2002, 1);

IF NOT EXISTS (SELECT 1 FROM ProductoProveedor WHERE codigoBarra = 1003 AND idProveedor = 2)
    INSERT INTO ProductoProveedor (codigoBarra, idProveedor, codigoBarraProveedor, estado) VALUES (1003, 2, 3001, 1);

IF NOT EXISTS (SELECT 1 FROM ProductoProveedor WHERE codigoBarra = 1004 AND idProveedor = 2)
    INSERT INTO ProductoProveedor (codigoBarra, idProveedor, codigoBarraProveedor, estado) VALUES (1004, 2, 3002, 1);

IF NOT EXISTS (SELECT 1 FROM ProductoProveedor WHERE codigoBarra = 1005 AND idProveedor = 3)
    INSERT INTO ProductoProveedor (codigoBarra, idProveedor, codigoBarraProveedor, estado) VALUES (1005, 3, 4001, 1);
GO

-- Insert Test Orders (Pedidos) - Check each individually
-- Note: fechaRegistro will use DEFAULT GETDATE() automatically
IF NOT EXISTS (SELECT 1 FROM Pedido WHERE estado = 1 AND proveedor = 1 AND fechaEstimada = '2025-01-15 10:30:00')
    INSERT INTO Pedido (estado, proveedor, fechaEstimada, fechaEntrega, evaluacionEscala) VALUES (1, 1, '2025-01-15 10:30:00', NULL, NULL);

IF NOT EXISTS (SELECT 1 FROM Pedido WHERE estado = 2 AND proveedor = 1 AND fechaEstimada = '2025-01-20 14:15:00')
    INSERT INTO Pedido (estado, proveedor, fechaEstimada, fechaEntrega, evaluacionEscala) VALUES (2, 1, '2025-01-20 14:15:00', NULL, NULL);

IF NOT EXISTS (SELECT 1 FROM Pedido WHERE estado = 5 AND proveedor = 2 AND fechaEstimada = '2025-01-10 09:00:00')
    INSERT INTO Pedido (estado, proveedor, fechaEstimada, fechaEntrega, evaluacionEscala) VALUES (5, 2, '2025-01-10 09:00:00', '2025-01-12 16:30:00', 5);

IF NOT EXISTS (SELECT 1 FROM Pedido WHERE estado = 5 AND proveedor = 2 AND fechaEstimada = '2025-01-18 11:00:00')
    INSERT INTO Pedido (estado, proveedor, fechaEstimada, fechaEntrega, evaluacionEscala) VALUES (5, 2, '2025-01-18 11:00:00', '2025-01-20 10:00:00', 4);

IF NOT EXISTS (SELECT 1 FROM Pedido WHERE estado = 3 AND proveedor = 3 AND fechaEstimada = '2025-01-25 08:00:00')
    INSERT INTO Pedido (estado, proveedor, fechaEstimada, fechaEntrega, evaluacionEscala) VALUES (3, 3, '2025-01-25 08:00:00', NULL, NULL);
GO
...
SELECT @Pedido1 = id FROM Pedido WHERE estado = 1 AND proveedor = 1 AND fechaEstimada = '2025-01-15 10:30:00';
SELECT @Pedido2 = id FROM Pedido WHERE estado = 2 AND proveedor = 1 AND fechaEstimada = '2025-01-20 14:15:00';
SELECT @Pedido3 = id FROM Pedido WHERE estado = 5 AND proveedor = 2 AND fechaEstimada = '2025-01-10 09:00:00';
SELECT @Pedido4 = id FROM Pedido WHERE estado = 5 AND proveedor = 2 AND fechaEstimada = '2025-01-18 11:00:00';
SELECT @Pedido5 = id FROM Pedido WHERE estado = 3 AND proveedor = 3 AND fechaEstimada = '2025-01-25 08:00:00';
